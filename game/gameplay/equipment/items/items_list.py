...
# # # WINGS # # #
WINGS = {
    "angel_wings": Item("angel wings", "wings", attack_multiply=1.2, hp_multiply=1.2, speed=16),
    "demonic_wings": Item("demonic wings", "wings", attack_multiply=1.5, hp_multiply=1.3, speed=14),
    "dragon_wings": Item("dragon wings", "wings", attack_multiply=2, hp_multiply=2, speed=10),
}
